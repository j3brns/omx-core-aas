...
from platform_tools.orchestration import DurableSession, OrchestrationState
...
class OMXAgentApp(BedrockAgentCoreApp):
    ...
    def omx_entrypoint(self, func: Callable[[dict[str, Any], RequestContext, DurableSession], Any]) -> Callable:
